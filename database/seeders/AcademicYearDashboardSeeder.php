...
class AcademicYearDashboardSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Enrollment::create([
            ...
            'class_schedule_id' => $classSchedule1->id,
            'enrollment_date'   => Carbon::parse('2025-08-20'),
        ]);
        Enrollment::create([
            'student_id'        => $student2->id,
            'class_schedule_id' => $classSchedule1->id,
            'enrollment_date'   => Carbon::parse('2025-08-21'),
        ]);
        Enrollment::create([
            'student_id'        => $student3->id,
            'class_schedule_id' => $classSchedule1->id,
            'enrollment_date'   => Carbon::parse('2025-08-22'),
        ]);
        Enrollment::create([
            'student_id'        => $student4->id,
            'class_schedule_id' => $classSchedule1->id,
            'enrollment_date'   => Carbon::parse('2025-08-23'),
        ]);
        Enrollment::create([
            'student_id'        => $student1->id,
            'class_schedule_id' => $classSchedule3->id,
            'enrollment_date'   => Carbon::parse('2025-08-20'),
        ]);
        Enrollment::create([
            'student_id'        => $student2->id,
        ...
        Enrollment::create([
            'student_id'        => $student3->id,
            'class_schedule_id' => $classSchedule4->id,
            'enrollment_date'   => Carbon::parse('2025-08-22'),
        ]);
    }
}
