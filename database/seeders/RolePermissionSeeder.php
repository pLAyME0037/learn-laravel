    ...
    private function getPermissionsConfig(): array
    {
        return [
            ...
            'Academic Year Management' => [
                ...
                'manage.academic-years' => 'Manage academic years profiles',
            ],
            'Report Management' => [
        ...
        return [
            ...
            'register'            => [
                ...
                'permissions' => [
                    ...
                    'view.class-schedules', 'view.classrooms', 'view.academic-years',
            ...
            'staff'               => [
                ...
                'permissions' => [
                    ...
                    'view.academic-years', 'view.semesters', 'view.faculties', 'view.departments',
