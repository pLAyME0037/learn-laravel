...
{
    // State
    public $selectedCategory = 'general'; // Default tab
    ...
    public function refreshCategories()
    {
        ...
        $defaults = ['gender', 'academic_status', 'enrollment_status', 'titles'];
    ...
    public function save()
    {
        $this->validate([
            ...
            'key' => [
                ...
                Rule::unique('dictionaries')->where(fn ($q) => $q->where('category', $this->category))->ignore($this->id)
            ],
    ...
    {
        $items = Dictionary::where('category', $this->selectedCategory)
            ->orderBy('key')
            ->get();
