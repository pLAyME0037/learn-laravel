                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.students.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-select-input id="gender_id" class="block mt-1 w-full" name="gender_id" :value="old('gender_id')" required>
                        ...
                        <div class="mt-4">
                            ...
                            <x-select-input id="program_id" class="block mt-1 w-full" name="program_id" :value="old('program_id')" required>
                        ...
                        <div class="mt-4">
                            ...
                            <x-select-input id="major_id" class="block mt-1 w-full" name="major_id" :value="old('major_id')" required>
                        ...
                        <div class="mt-4">
                            ...
                            <x-select-input id="academic_year_id" class="block mt-1 w-full" name="academic_year_id" :value="old('academic_year_id')" required>
