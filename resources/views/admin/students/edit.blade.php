            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg mb-6">
                        <img class="h-16 w-16 rounded-full" src="{{ $student->user->profile_picture_url }}" alt="{{ $student->user->name }}">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ $student->user->name }}</h3>
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                {{ $student->student_id }} • {{ $student->department->name ?? 'N/A' }} • {{ $student->program->name ?? 'N/A' }}
                            </p>
                        </div>
                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        @if($student->user->profile_pic)
                                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Current: {{ basename($student->user->profile_pic) }}</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <select id="program_id" name="program_id" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="admission_date" name="admission_date" type="date" class="mt-1 block w-full" 
                                    ...
                                    <!-- Expected Graduation -->
                                    <div>
                                        <x-input-label for="expected_graduation" :value="__('Expected Graduation')" />
                                        <x-text-input id="expected_graduation" name="expected_graduation" type="date" class="mt-1 block w-full" 
                                            :value="old('expected_graduation', $student->expected_graduation?->format('Y-m-d'))" />
                                        <x-input-error class="mt-2" :messages="$errors->get('expected_graduation')" />
                                    </div>

                                    <!-- Current Semester -->
                                    <div>
                                        <x-input-label for="current_semester" :value="__('Current Semester')" />
                                        <x-text-input id="current_semester" name="current_semester" type="number" min="1" max="12" class="mt-1 block w-full" 
                                    ...
                                    <!-- Academic Status -->
                                    <div>
                                        <x-input-label for="academic_status" :value="__('Academic Status')" />
                                        <select id="academic_status" name="academic_status" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                            <option value="active" {{ old('academic_status', $student->academic_status) == 'active' ? 'selected' : '' }}>Active</option>
                                            <option value="probation" {{ old('academic_status', $student->academic_status) == 'probation' ? 'selected' : '' }}>Probation</option>
                                            <option value="suspended" {{ old('academic_status', $student->academic_status) == 'suspended' ? 'selected' : '' }}>Suspended</option>
                                            <option value="graduated" {{ old('academic_status', $student->academic_status) == 'graduated' ? 'selected' : '' }}>Graduated</option>
                                            <option value="withdrawn" {{ old('academic_status', $student->academic_status) == 'withdrawn' ? 'selected' : '' }}>Withdrawn</option>
                                            <option value="transfered" {{ old('academic_status', $student->academic_status) == 'transfered' ? 'selected' : '' }}>Transfered</option>
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        <select id="enrollment_status" name="enrollment_status" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                            <option value="full_time" {{ old('enrollment_status', $student->enrollment_status) == 'full_time' ? 'selected' : '' }}>Full Time</option>
                                            <option value="part_time" {{ old('enrollment_status', $student->enrollment_status) == 'part_time' ? 'selected' : '' }}>Part Time</option>
                                            <option value="exchange" {{ old('enrollment_status', $student->enrollment_status) == 'exchange' ? 'selected' : '' }}>Exchange</option>
                                            <option value="study_abroad" {{ old('enrollment_status', $student->enrollment_status) == 'study_abroad' ? 'selected' : '' }}>Study Abroad</option>
                                        </select>
                                    ...
                                    <!-- Fee Category -->
                                    <div>
                                        <x-input-label for="fee_category" :value="__('Fee Category')" />
                                        <select id="fee_category" name="fee_category" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                            <option value="regular" {{ old('fee_category', $student->fee_category) == 'regular' ? 'selected' : '' }}>Regular</option>
                                            <option value="scholarship" {{ old('fee_category', $student->fee_category) == 'scholarship' ? 'selected' : '' }}>Scholarship</option>
                                            <option value="financial_aid" {{ old('fee_category', $student->fee_category) == 'financial_aid' ? 'selected' : '' }}>Financial Aid</option>
                                            <option value="self_financed" {{ old('fee_category', $student->fee_category) == 'self_financed' ? 'selected' : '' }}>Self Financed</option>
                                        </select>
                                        <x-input-error class="mt-2" :messages="$errors->get('fee_category')" />
                                    </div>

                                    <!-- Has Outstanding Balance -->
                                    <div class="flex items-center">
                                        <input id="has_outstanding_balance" name="has_outstanding_balance" type="checkbox" 
                                        ...
                                        <x-input-label for="has_outstanding_balance" :value="__('Has Outstanding Balance')" class="ml-2" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <x-input-label for="has_disability" :value="__('Has Disability')" class="ml-2" />
                                    </div>

                                    <!-- Disability Details -->
                                    <div class="md:col-span-2">
                                        <x-input-label for="disability_details" :value="__('Disability Details')" />
                                        ...
                                        <x-input-error class="mt-2" :messages="$errors->get('disability_details')" />
                                    </div>

                                    <!-- Previous Education -->
                                    <div class="md:col-span-2">
                                        <x-input-label for="previous_education" :value="__('Previous Education')" />
                                        <textarea id="previous_education" name="previous_education" rows="3"
                                        ...
                                        <x-input-error class="mt-2" :messages="$errors->get('previous_education')" />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="current_address" name="current_address" rows="3"
                                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>{{ old('current_address', $student->current_address) }}</textarea>
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <textarea id="permanent_address" name="permanent_address" rows="3"
                                            class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>{{ old('permanent_address', $student->permanent_address) }}</textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="emergency_contact_name" name="emergency_contact_name" type="text" class="mt-1 block w-full" 
                                            :value="old('emergency_contact_name', $student->emergency_contact_name)" required />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="emergency_contact_phone" name="emergency_contact_phone" type="text" class="mt-1 block w-full" 
                                            :value="old('emergency_contact_phone', $student->emergency_contact_phone)" required />
                                        <x-input-error class="mt-2" :messages="$errors->get('emergency_contact_phone')" />
                                    </div>

                                    <!-- Emergency Contact Relation -->
                                    <div>
                                        <x-input-label for="emergency_contact_relation" :value="__('Relationship')" />
                                        <x-text-input id="emergency_contact_relation" name="emergency_contact_relation" type="text" class="mt-1 block w-full" 
                                            :value="old('emergency_contact_relation', $student->emergency_contact_relation)" required />
