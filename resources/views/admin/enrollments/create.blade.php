                ...
                <form method="POST"
                    ...
                    <div>
                        ...
                        <select id="student_id"
                            name="student_id"
                            class="dark:bg-gray-900 bg-gray-200 dark:text-gray-100 text-gray-900 block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <select id="class_schedule_id"
                            ...
                            @foreach ($classSchedules as $classSchedule)
                                <option value="{{ $classSchedule->id }}"
                                    ...
                                    {{ str_pad($classSchedule->course_name, 25) }} 
                                    | {{ str_pad($classSchedule->day_of_week, 15) }} 
                                    | {{ str_pad($classSchedule->start_time, 10) }}
                                </option>
                            @endforeach
                        </select>
