<x-app-layout title="Edit Major"
    :pageTitle="__('Edit Major')">
            ...
            <form method="POST"
                    ...
                    <select id="degree_id"
                        ...
                        @foreach ($degrees as $degree)
                            <option value="{{ $degree->id }}"
                                {{ old('degree_id', $major->degree_id) == $degree->id ? 'selected' : '' }}>
                                {{ $degree->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mt-4">
                    ...
                    <x-textarea-input id="description"
                        class="block mt-1 w-full"
                        name="description">{{ old('description', $major->description) }}</x-textarea-input>
