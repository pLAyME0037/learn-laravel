<x-app-layout title="Create Major"
    :pageTitle="__('Create New Major')">
        ...
        <div class="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg p-6">
            <form method="POST"
                    ...
                    <select id="degree_id"
                        ...
                        @foreach ($degrees as $degree)
                            <option value="{{ $degree->id }}"
                                {{ old('degree_id') == $degree->id ? 'selected' : '' }}>{{ $degree->name }}</option>
                        @endforeach
                    </select>
                ...
                <div class="flex items-center justify-end mt-4">
                    <x-secondary-button href="{{ route('admin.majors.index') }}"
                        class="ml-4">
                        {{ __('Cancel') }}
                    </x-secondary-button>
