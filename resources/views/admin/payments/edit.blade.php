                    ...
                    <select id="semester_id"
                        ...
                        @foreach ($semesters as $semester)
                            <option value="{{ $semester->id }}"
                                {{ old('semester_id', $payment->semester_id) == $semester->id ? 'selected' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <select id="method"
                        ...
                        <option value="Credit Card"
                            {{ old('method', $payment->method) == 'Credit Card' ? 'selected' : '' }}>
                            Credit Card
                        </option>
                        <option value="Bank Transfer"
                            {{ old('method', $payment->method) == 'Bank Transfer' ? 'selected' : '' }}>
                            Bank Transfer
                        </option>
                        <option value="Other"
                            {{ old('method', $payment->method) == 'Other' ? 'selected' : '' }}>
                            Other
                        </option>
                    </select>
