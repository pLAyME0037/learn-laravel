            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <div class="flex items-start space-x-6">
                        <img class="h-24 w-24 rounded-full" src="{{ $user->profile_picture_url }}" alt="{{ $user->name }}">
                        <div class="flex-1">
                    ...
                    <div class="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white"><span>@</span>{{ $user->username }}</dd>
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm {{ $user->email_verified_at ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white capitalize">{{ $user->role }}</dd>
                            </div>
                            
                            <div>
                                <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Status</dt>
                                <dd class="mt-1 text-sm {{ $user->is_active ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400' }}">
                                    {{ $user->is_active ? 'Active' : 'Inactive' }}
                                </dd>
                            </div>
                    ...
                    <div class="mt-8 border-t border-gray-200 dark:border-gray-700 pt-6">
                        ...
                        <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $user->last_login_at ? $user->last_login_at->diffForHumans() : 'Never' }}</dd>
                            </div>
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            ...
                            <div class="text-center p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 dark:text-white">{{ $user->created_at->diffForHumans() }}</dd>
                            </div>
                        </div>
                    </div>
                </div>
