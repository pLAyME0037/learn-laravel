                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select id="address.province_id"
                                        wire:model.live="address.province_id"
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm 
                                        @error('address.province_id') border-red-500 @enderror">
                                    ...
                                    <x-input-error class="mt-2"
                                        :messages="$errors->get('address.province_id')" />
                                </div>

                                <div>
                                    <x-input-label for="address.district_id"
                                        :value="__('District')" />
                                    <select id="address.district_id"
                                        wire:model.live="address.district_id"
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm"
                                    ...
                                    <x-input-error class="mt-2"
                                        :messages="$errors->get('address.district_id')" />
                                </div>

                                <div>
                                    <x-input-label for="address.commune_id"
                                        :value="__('Commune')" />
                                    <select id="address.commune_id"
                                        wire:model.live="address.commune_id"
                                        class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 rounded-md shadow-sm"
                                    ...
                                    <x-input-error class="mt-2"
                                        :messages="$errors->get('address.commune_id')" />
                                </div>

                                <div>
                                    <x-input-label for="address.village_id"
                                        :value="__('Village')" />
